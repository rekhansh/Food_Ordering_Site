            ...
            <div class="row">
                <div class="col-md-12">
					...
					<div class="form-group">
						...
						<?php echo"<a href='order_update.php?id=". $row['order_id'] ."' title='Update Status' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>" ?>
                    </div>
					<?php 
